 ...
 *
 * This is overridden because there was a bug in the data picker causing the
 * selected text to appear with the escaped HTML entities.
 *
 * Search for: THIS IS FIXED
 */
((exports) => {
  class DataPicker {
