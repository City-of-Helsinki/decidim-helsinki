/**
 * Customized to fix a HTML validation issue within the picker content (heading
 * level h6 -> h2).
 */
export default class DataPicker {
  ...
  _createModalContainer() {
    ...
    const headerHtml = '<div class="scope-picker picker-header"><h2 id="data_picker-title" class="h2"></h2></div>';
