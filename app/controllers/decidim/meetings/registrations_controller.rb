...
# The registrations controller has been overridden because with the core
# functionality the user is redirected to the application root path in case they
# are not logged in prior to trying to accept or decline an invitaiton.
module Decidim
  module Meetings
