...
# This is overridden because of a core bug that made the managed users work so
# that each of them would need to have a unique "name" which is not acceptable
# as this is an easy way for admin users to make mistakes.
#
# Should be fixed once this PR is merged to the core:
# https://github.com/decidim/decidim/pull/5318
module Decidim
  module Admin
