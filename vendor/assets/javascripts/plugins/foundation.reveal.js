// This file is overridden from Foundation because of a Foundation a11y bug that
// causes all dialog controlling elements (the buttons or links that open the
// dialog) to get a `aria-haspopup="true"` attribute set to their elements. This
// is incorrect because the correct attribute value is "dialog" for modal/reveal
// dialogs. `aria-haspopup="true"` indicates a popup menu instead of a dialog
// window.
//
// See:
// https://www.w3.org/TR/wai-aria-1.1/#menu (equivalent to value "true")
// https://www.w3.org/TR/wai-aria-1.1/#dialog
//
// TODO: Remove after the following PR is merged to foundation-sites:
// https://github.com/foundation/foundation-sites/pull/12248
